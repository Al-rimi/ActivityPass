...
SITES_DIR="/opt/1panel/apps/openresty/openresty/www/sites/index"
...
print_status "     - Alias: $ALIAS"
print_status "     - Root Directory: ${SITES_DIR}/${ALIAS} (1Panel will automatically serve from the index subdirectory)"
print_status ""
